    ...
    <div class="grid lg:grid-cols-5 md:grid-cols-4 grid-cos-1 gap-12 xl:mx-32 lg:mx-20 sm:mx-10 md:mx-10 mx-4">
      ...
      <div class="left w-full lg:col-span-3 md:col-span-2 cos-span-1 sm:text-left text-center">
        <div class="sm:contents hidden">
          ...
          <h1 class="xl:tracking-widest tracking-wide glay text-3xl">Google Analytics 4がもっとわかる</h1>
          <p class="lg:tracking-widest glay text-sm mt-3">本フォーム入力後、メールアドレスあてに自動返信メールにて、</p>
          <p class="lg:tracking-widest glay text-sm mb-8">すぐに資料を添付させて頂きます。</p>
        </div>

        <div class="sm:hidden contents">
          <h1 class="xl:tracking-widest tracking-wide glay text-3xl">Google Analytics 4が</h1>
        ...
        <img src="@/assets/ga4_main.png" class="text-gray-800  text-center mx-auto sdw block rds">
        
        <div class="mt-5">
          <ul class="text-gray-500 md:text-lg w-max  grid grid-cos-1 mx-auto">
            <h1 class="glay tracking-widest orange text-2xl mb-2 cos-span-1"><img src="@/assets/light_icon.png" alt="Logo" class="mb-2.5 mr-2 inline-block">この資料でわかること</h1>
            <li class="glay sm:tracking-widest tracking-wide cos-span-1">・GoogleAnalytics 4とは</li>
            <li class="glay sm:tracking-widest tracking-wide cos-span-1">・GoogleAnalytics 4の5つの変更点</li>
            <li class="glay sm:tracking-widest tracking-wide cos-span-1">・GA4導入を今すぐ行う必要性</li>
            <li class="glay sm:tracking-widest tracking-wide cos-span-1">・導入サポートの料金費用</li>
            <li class="glay sm:tracking-widest tracking-wide cos-span-1">・ご発注から計測開始までのスケジュール</li>
          </ul>
        </div>
      </div>

      <div class="right px-4 pt-14 pb-4 lg:col-span-2 md:col-span-2 cos-span-1 md:h-min mx-auto md:w-full sm:w-10/12 sdw">
        <!-- form - start -->
        <form class="max-w-screen-md grid sm:grid-cols-2 gap-4 mx-auto">
          ...
          <div class="sm:col-span-2 mx-3 text-center">
            <input type="button" @click="getForm" value="資料をダウンロード" class="tracking-widest w-full bg-yellow-200 hover:bg-yellow-300 active:bg-yellow-500 focus-visible:ring ring-gray-300 text-black xl:text-2xl lg:text-lg md:text-base sm:text-lg text-sm font-semibold rds sdw outline-none transition duration-100 px-8 py-3 mx-auto">
          </div>
        </form>
        <!-- form - end -->
      </div>
